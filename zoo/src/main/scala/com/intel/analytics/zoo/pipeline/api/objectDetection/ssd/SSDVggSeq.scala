...
object SSDVggSeq {
  ...
  private def vgg16Part1(): Sequential[Float] = {
    ...
    SSD.addConvRelu(vggNetPart1, (3, 64, 3, 1, 1), "1_1", propogateBack = false)
    SSD.addConvRelu(vggNetPart1, (64, 64, 3, 1, 1), "1_2")
    vggNetPart1.add(SpatialMaxPooling(2, 2, 2, 2).ceil().setName("pool1"))

    SSD.addConvRelu(vggNetPart1, (64, 128, 3, 1, 1), "2_1")
    SSD.addConvRelu(vggNetPart1, (128, 128, 3, 1, 1), "2_2")
    vggNetPart1.add(SpatialMaxPooling(2, 2, 2, 2).ceil().setName("pool2"))

    SSD.addConvRelu(vggNetPart1, (128, 256, 3, 1, 1), "3_1")
    SSD.addConvRelu(vggNetPart1, (256, 256, 3, 1, 1), "3_2")
    SSD.addConvRelu(vggNetPart1, (256, 256, 3, 1, 1), "3_3")
    vggNetPart1.add(SpatialMaxPooling(2, 2, 2, 2).ceil().setName("pool3"))

    SSD.addConvRelu(vggNetPart1, (256, 512, 3, 1, 1), "4_1")
    SSD.addConvRelu(vggNetPart1, (512, 512, 3, 1, 1), "4_2")
    SSD.addConvRelu(vggNetPart1, (512, 512, 3, 1, 1), "4_3")
    vggNetPart1
  }
  ...
  private def vgg16Part2(): Sequential[Float] = {
    ...
    SSD.addConvRelu(vggNetPart2, (512, 512, 3, 1, 1), "5_1")
    SSD.addConvRelu(vggNetPart2, (512, 512, 3, 1, 1), "5_2")
    SSD.addConvRelu(vggNetPart2, (512, 512, 3, 1, 1), "5_3")
