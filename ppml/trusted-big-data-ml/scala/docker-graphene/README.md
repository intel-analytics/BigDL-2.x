...
```
You also need to generate your enclave key using the command below, and keep it for safely future remote attestations and to start SGX enclaves more securely.
