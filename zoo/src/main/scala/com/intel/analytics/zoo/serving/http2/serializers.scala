...
import com.intel.analytics.zoo.serving.http.JsonUtil.jacksonJsonSerializer
import com.intel.analytics.zoo.serving.http.{JacksonJsonSerializer, SerializeSuported}
