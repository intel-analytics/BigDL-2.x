...
class RotationTransformerSpec extends FlatSpec with Matchers{
  ...
  "A RotationTransformer" should "generate correct output when dimension of height is 1" in {
    ...
    val image = ImageFeature3D(input)
    val dst = rot.transform(image)
    val dstTorch = Tensor[Double](Array[Double](0.0, 0.0, 0.0, 0.9337607, 0.63041264, 0.41022006, 0.4238756, 0.38179016, 0.0, 0.0,
      0.0, 0.3837239, 0.48049465, 0.86388755,	0.66710216,	0.3300809, 0.28570667, 0.45415232, 0.44336346, 0.0,
      0.66483647, 0.43097502, 0.3237357, 0.8518211, 0.66504264, 0.34306353, 0.39141575, 0.7155649, 0.51030886, 0.0,
      0.54608387, 0.43258587, 0.25251946, 0.43319377, 0.5893668, 0.23969816, 0.25210613, 0.511659, 0.29608712, 0.5754271,
      0.57577354, 0.75738704, 0.5187364, 0.45187342, 0.5245649, 0.71314573, 0.19431172, 0.33923146, 0.24373981, 0.69405204,
      0.685539, 0.64075524, 0.5302063, 0.14410771, 0.43040138, 0.7441464, 0.50390047, 0.5271677, 0.098411895, 0.42417723,
      0.7500948, 0.34451854, 0.25963393, 0.35118395, 0.45892385, 0.74234974, 0.34206071, 0.27863282, 0.26684713, 0.29670718,
      0.0, 0.30849406, 0.2423132, 0.51493, 0.63804555, 0.3836444, 0.09990372, 0.14387289, 0.481886, 0.5588326,
      0.0, 0.10782696, 0.14325471, 0.17757198, 0.5234246, 0.33868256, 0.083803356, 0.45793825, 0.5710847, 0.0,
      0.0, 0.0, 0.22376697, 0.33324337, 0.50276846, 0.5293505, 0.43991444, 0.0, 0.0, 0.0), Array(10, 10))
    val dstTensor = Tensor[Double](
      storage = Storage[Double](dst[Tensor[Float]](ImageFeature.imageTensor).storage().array()
