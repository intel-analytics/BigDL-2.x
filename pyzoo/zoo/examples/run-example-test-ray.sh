...
echo "# sync_parameter_server time used:$time2 seconds"
echo "# async_parameter_server time used:$time3 seconds"
echo "# multiagent_two_trainers time used:$time3 seconds"