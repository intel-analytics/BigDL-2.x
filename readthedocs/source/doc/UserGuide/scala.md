...
Before running Analytics Zoo's example code, Environment Variables **ANALYTICS_ZOO_HOME** and **SPARK_HOME** should be set:
...
#### **2.2.1 Run with Spark interactive shell**
...
#### **2.2.2 Run Analytics Zoo's example**
