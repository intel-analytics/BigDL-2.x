...
package com.intel.analytics.zoo.pipeline.api.objectDetection.common.nn
 ...
 * @tparam T
 */
class SmoothL1CriterionWithWeights2[@specialized(Float, Double) T: ClassTag]
...
object SmoothL1CriterionWithWeights2 {
  def apply[@specialized(Float, Double) T: ClassTag](sigma: Double, num: Int = 0)
    (implicit ev: TensorNumeric[T]): SmoothL1CriterionWithWeights2[T] =
    new SmoothL1CriterionWithWeights2[T](sigma, num)
}
