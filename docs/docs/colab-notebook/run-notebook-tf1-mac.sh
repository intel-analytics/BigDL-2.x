...
start=$(date "+%s")
${ANALYTICS_ZOO_HOME}/apps/ipynb2py-mac.sh ${ANALYTICS_ZOO_HOME}/docs/docs/colab-notebook/orca/quickstart/tf_lenet_mnist
sed -i '' -e '/get_ipython/s/^/#/' ${ANALYTICS_ZOO_HOME}/docs/docs/colab-notebook/orca/quickstart/tf_lenet_mnist.py
...
start=$(date "+%s")
${ANALYTICS_ZOO_HOME}/apps/ipynb2py-mac.sh ${ANALYTICS_ZOO_HOME}/docs/docs/colab-notebook/orca/quickstart/keras_lenet_mnist
sed -i '' -e '/get_ipython/s/^/#/' ${ANALYTICS_ZOO_HOME}/docs/docs/colab-notebook/orca/quickstart/keras_lenet_mnist.py
...
${ANALYTICS_ZOO_HOME}/apps/ipynb2py-mac.sh ${ANALYTICS_ZOO_HOME}/docs/docs/colab-notebook/chronos/chronos_autots_nyc_taxi
sed -i '' -e '/get_ipython/s/^/#/' ${ANALYTICS_ZOO_HOME}/docs/docs/colab-notebook/chronos/chronos_autots_nyc_taxi.py
start=$(date "+%s")
...
${ANALYTICS_ZOO_HOME}/apps/ipynb2py-mac.sh ${ANALYTICS_ZOO_HOME}/docs/docs/colab-notebook/orca/quickstart/ncf_xshards_pandas
sed -i '' -e '/get_ipython/s/^/#/' ${ANALYTICS_ZOO_HOME}/docs/docs/colab-notebook/orca/quickstart/ncf_xshards_pandas.py
start=$(date "+%s")
...
${ANALYTICS_ZOO_HOME}/apps/ipynb2py-mac.sh ${ANALYTICS_ZOO_HOME}/docs/docs/colab-notebook/orca/examples/basic_text_classification
sed -i '' -e '/get_ipython/s/^/#/' ${ANALYTICS_ZOO_HOME}/docs/docs/colab-notebook/orca/examples/basic_text_classification.py
start=$(date "+%s")
