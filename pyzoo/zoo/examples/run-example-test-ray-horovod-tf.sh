...
echo "yolov3 predict"
python ${ANALYTICS_ZOO_ROOT}/pyzoo/zoo/examples/orca/learn/tf2/yolov3/predict.py --checkpoint ./checkpoints/yolov3.tf --names analytics-zoo-data/coco.names --class_num 80 --image analytics-zoo-data/VOCdevkit/VOC2007/JPEGImages/000005.jpg
