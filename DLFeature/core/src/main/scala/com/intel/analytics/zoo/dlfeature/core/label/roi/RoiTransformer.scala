...
package com.intel.analytics.zoo.dlfeature.core.label.roi
...
import com.intel.analytics.zoo.dlfeature.core.util.{BboxUtil, NormalizedBox}

import scala.collection.mutable.ArrayBuffer


case class RoiNormalize() extends LabelTransformMethod {
...
case class RoiCrop() extends LabelTransformMethod {
  override def apply(feature: Feature): Feature = {
    val height = feature.getHeight()
    val width = feature.getWidth()
    val bbox = feature("bbox").asInstanceOf[NormalizedBox]
    val target = feature(Feature.label).asInstanceOf[RoiLabel]
...
case class RoiHFlip() extends LabelTransformMethod {
  override def apply(feature: Feature): Feature = {
...
case class RoiExpand() extends LabelTransformMethod {
