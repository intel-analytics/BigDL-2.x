...
Run Spark Test
   ...
   Run Shell                        ${submit} --master ${spark_master} --driver-memory 5g --executor-memory 10g --total-executor-cores 32 --executor-cores 8 --class com.intel.analytics.zoo.examples.tfnet.Predict ${jar_path} --image ${public_hdfs_master}:9000/ojdresult/ --model ${integration_data_dir}/models/frozen_inference_graph.pb --partition 4
