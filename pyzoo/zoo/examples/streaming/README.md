# Analytics Zoo Streaming Inferece Examples
...
2. [Streaming Text Classification](https://github.com/intel-analytics/analytics-zoo/tree/master/pyzoo/zoo/examples/streaming/textclassification) uses pre-trained CCN/LSTM model to classify text from network input.
