...
run(){
	...
	start=$(date "+%s")
	${ANALYTICS_ZOO_HOME}/apps/ipynb2py-mac.sh ${ANALYTICS_ZOO_HOME}/docs/docs/colab-notebook/$2
	sed -i '' -e '/get_ipython/s/^/#/' ${ANALYTICS_ZOO_HOME}/docs/docs/colab-notebook/$2.py
