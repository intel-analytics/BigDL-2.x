...
if (( $# < 1)); then
  ...
  echo "Usage example: bash release_mac.sh default 2.4.3 bigdl-SPARK_2.4 spark_2.4+"
  echo "Usage example: bash release_mac.sh 0.6.0.dev0 2.4.3 bigdl-SPARK_2.4 spark_2.4+"
  exit -1
fi
