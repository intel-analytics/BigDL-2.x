...
def doppelganger_g_loss(d_fake,
                        attr_d_fake,
                        g_attr_d_coe=1):
...
def doppelganger_d_loss(d_fake,
                        d_real,
...
def doppelganger_attr_d_loss(attr_d_fake,
                             attr_d_real,
                             gradient_penalty=True,
                             ...
                             real_attribute_pl=None,
                             attr_d_gp_coe=0):
    batch_size = attr_d_fake.shape[0]
    if gradient_penalty:
...
# will not be used in pl version
