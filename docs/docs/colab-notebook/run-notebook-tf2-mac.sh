...
start=$(date "+%s")
${ANALYTICS_ZOO_HOME}/apps/ipynb2py-mac.sh ${ANALYTICS_ZOO_HOME}/docs/docs/colab-notebook/orca/quickstart/tf2_keras_lenet_mnist
sed -i '' -e '/get_ipython/s/^/#/' $ANALYTICS_ZOO_HOME/docs/docs/colab-notebook/orca/quickstart/tf2_keras_lenet_mnist.py
...
start=$(date "+%s")
${ANALYTICS_ZOO_HOME}/apps/ipynb2py-mac.sh ${ANALYTICS_ZOO_HOME}/docs/docs/colab-notebook/orca/quickstart/ncf_dataframe
sed -i '' -e '/get_ipython/s/^/#/' ${ANALYTICS_ZOO_HOME}/docs/docs/colab-notebook/orca/quickstart/ncf_dataframe.py
