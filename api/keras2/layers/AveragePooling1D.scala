 ...
 *
 * @param poolSize Size of the region to which average pooling is applied. Integer. Default is 2.
...
class AveragePooling1D[T: ClassTag](
  ...
  extends klayers1.AveragePooling1D[T](poolLength = poolSize,
...
object AveragePooling1D {
  def apply[@specialized(Float, Double) T: ClassTag](
    ...
    new AveragePooling1D[T](poolSize, strides, padding, inputShape)
  }
}
