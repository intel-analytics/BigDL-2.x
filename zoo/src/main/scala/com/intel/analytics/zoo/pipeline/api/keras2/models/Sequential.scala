...
import com.intel.analytics.zoo.pipeline.api.keras.models.{Sequential => Keras1Sequential}

import scala.reflect.ClassTag


class Sequential[T: ClassTag]()(implicit ev: TensorNumeric[T])
  extends Keras1Sequential[T]{

}

object Sequential extends KerasLayerSerializable {
  ModuleSerializer.registerModule(
    "com.intel.analytics.zoo.pipeline.api.keras2.models.Sequential",
    Sequential)
