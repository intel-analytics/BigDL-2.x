...
1. [Streaming Object Detection]() uses pre-trained SSD model to detect objects in images.
2. [Streaming Text Classification]() uses pre-trained CCN/LSTM model to classify text from network input.
