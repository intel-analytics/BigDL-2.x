...
Run Spark Test
   ...
   Run Shell                        ${submit} --master ${spark_master} --driver-memory 5g --executor-memory 10g --total-executor-cores 32 --executor-cores 8 --class com.intel.analytics.zoo.examples.nnframes.finetune.ImageFinetune ${jar_path} --modelPath ${integration_data_dir}/models/analytics-zoo_inception-v1_imagenet_0.1.0.model --batchSize 32 --imagePath ${integration_data_dir}/dogs_cats/samples --nEpochs 2
   Log To Console                   begin imageInference
   Run Shell                        ${submit} --master ${spark_master} --driver-memory 5g --executor-memory 10g --total-executor-cores 32 --executor-cores 8 --class com.intel.analytics.zoo.examples.nnframes.imageInference.ImageInferenceExample ${jar_path} --caffeDefPath ${integration_data_dir}/models/nnframes/deploy.prototxt --caffeWeightsPath ${integration_data_dir}/models/nnframes/bvlc_googlenet.caffemodel --batchSize 32 --imagePath ${integration_data_dir}/dogs_cats/samples
   Log To Console                   begin imageTransferLearning
   Run Shell                        ${submit} --master ${spark_master} --driver-memory 5g --executor-memory 10g --total-executor-cores 32 --executor-cores 8 --class com.intel.analytics.zoo.examples.nnframes.imageTransferLearning.ImageTransferLearning ${jar_path} --caffeDefPath ${integration_data_dir}/models/nnframes/deploy.prototxt --caffeWeightsPath ${integration_data_dir}/models/nnframes/bvlc_googlenet.caffemodel --batchSize 32 --imagePath ${integration_data_dir}/dogs_cats/samples --nEpochs 20
   Log To Console                   begin tfnet
   Run Shell                        ${submit} --master ${spark_master} --driver-memory 5g --executor-memory 10g --total-executor-cores 32 --executor-cores 8 --class com.intel.analytics.zoo.examples.tfnet.Predict ${jar_path} --image ${integration_data_dir}/ojdresult/ --model ${integration_data_dir}/models/frozen_inference_graph.pb --partition 4
