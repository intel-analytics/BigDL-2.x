...
package com.intel.analytics.zoo.pipeline.api.objectDetection.fasterrcnn

import com.intel.analytics.bigdl._
import com.intel.analytics.bigdl.dataset.Transformer
import com.intel.analytics.bigdl.models.utils.ModelBroadcast
import com.intel.analytics.bigdl.nn.{DetectionOutputFrcnn, SpatialShareConvolution,
        Utils => BUtils}
...
import com.intel.analytics.zoo.pipeline.api.objectDetection.common.dataset.roiimage.{ByteRecord,
        RecordToFeature}
...
class Validator(model: Module[Float],
  ...
  val postprocessor = BUtils.getNamedModules(model)
