...
if (( $# < 1)); then
  ...
  echo "Usage example: bash release_mac.sh default spark_version bigdl_artifactId spark_profile"
  echo "Usage example: bash release__mac.sh 0.6.0.dev0 spark_version bigdl_artifactId spark_profile"
  exit -1
fi
