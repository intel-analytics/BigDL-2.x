...
2. You are recommended to download Analytics Zoo prebuilt release and nightly build package from the [Release Page](../release-download.md) and uncompress it.
