...
public class ServerGrpc {
    ...
    // TODO: client number
    protected final int clientNum = 2;
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ZooGrpcServer server = new ZooGrpcServer(args, new PSIServiceImpl());
        server.start();
        server.blockUntilShutdown();
    }

    static private class PSIServiceImpl extends PSIServiceGrpc.PSIServiceImplBase {
