...
export PYTHONPATH=$PYTHONPATH:$PYSPARK_ZIP:$DL_PYTHON_HOME:$DL_PYTHON_HOME/:$DL_PYTHON_HOME/test/dev:$DL_PYTHON_HOME/test/resources/conf/spark-bigdl.conf:$HOME/BigDL/lib/bigdl-0.3.0-python-api/bigdl:$HOME/BigDL/lib/bigdl-0.3.0-python-api/bigdl/

export BIGDL_CLASSPATH=$(find $BIGDL_HOME/target/ -name "*with-dependencies.jar" | head -n 1)
