...
class TestSimpleIntegration(ZooTestCase):
    ...
    def test_training_with_tensorboard_checkpoint_gradientclipping(self):
        ...
        model.fit(X_train, y_train, batch_size=112, nb_epoch=4, validation_data=(X_test, y_test))
        model.set_gradient_clipping_by_l2_norm(0.2)
        model.fit(X_train, y_train, batch_size=112, nb_epoch=6, validation_data=(X_test, y_test))
