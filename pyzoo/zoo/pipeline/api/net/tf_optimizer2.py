...
class TFOptimizerDebug:
    def __init__(self, loss, optim_method, sess=None, dataset=None, inputs=None,
        ...
        if dataset is None:
            args = TFOptimizerDebug._get_arguments_from_loss(loss, optim_method, sess,
...
with variable_creator_scope():
    ...
    def from_loss(cls, loss, optim_method, session=None, val_outputs=None,
        ...
        args = TFOptimizerDebug._get_arguments_from_loss(loss, optim_method,
                                                         session, val_outputs,
    ...
    def from_keras(cls, keras_model, dataset, val_spilt=0.0, **kwargs):
        ...
        sess = K.get_session()
        optim_method = TFOptimizerDebug.to_bigdl_optim_method(keras_optimizer)
