...
Run Spark Test
   ...
   Run Shell                        ${ANALYTICS_ZOO_HOME}/bin/spark-shell-with-zoo.sh --master ${MASTER} --driver-memory 3g --executor-memory 3g --class com.intel.analytics.zoo.examples.qaranker.QARanker --dataPath ${dataDir} --embeddingFile ${glove.6B.100d.txt} --batchSize 196
