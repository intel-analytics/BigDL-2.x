...
import com.intel.analytics.bigdl.nn.{SplitTable, View}
import com.intel.analytics.bigdl.tensor.Tensor
import com.intel.analytics.bigdl.utils.{T, Table}
import com.intel.analytics.zoo.pipeline.api.keras.layers.{InternalJoinTable, InternalSplitTensor}
import org.scalatest.{FlatSpec, Matchers}

class InternalJoinTablepec extends FlatSpec with Matchers {
  "A InternalJoinTable" should "be able to work" in {
    ...
    val g1 = gradInput[Table](1)
    val g2 = gradInput[Table](2)
