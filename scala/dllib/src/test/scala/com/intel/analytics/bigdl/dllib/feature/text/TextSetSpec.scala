...
import com.intel.analytics.bigdl.dllib.zooKeras.layers.TimeDistributed
import com.intel.analytics.bigdl.dllib.zooKeras.metrics.Accuracy
import com.intel.analytics.bigdl.dllib.zooKeras.models.Sequential
import com.intel.analytics.bigdl.dllib.zooKeras.objectives.{RankHinge, SparseCategoricalCrossEntropy}
...
class TextSetSpec extends ZooSpecHelper {
  ...
  val path: String = getClass.getClassLoader.getResource("zoo/resources/news20").getPath
  ...
  val qaDir: String = getClass.getClassLoader.getResource("zoo/resources/qa").getPath
