...
class GlobalMaxPooling2D[T: ClassTag](
  ...
  extends klayers1.GlobalMaxPooling2D[T](dimOrdering = dataFormat, inputShape) with Net {}
...
object GlobalMaxPooling2D {
  def apply[@specialized(Float, Double) T: ClassTag](
    ...
    new GlobalMaxPooling2D[T](KerasUtils.toBigDLFormat(dataFormat), inputShape)
  }
}
