...
class CaffeSpatialAveragePooling[@specialized(Float, Double) T: ClassTag](
  var kW: Int,
  var kH: Int,
  val dW: Int = 1,
  val dH: Int = 1,
   ...
   * @return this
   */
  def ceil(): CaffeSpatialAveragePooling[T] = {
    ceilMode = true
    this
  }
   ...
   * @return this
   */
  def floor(): CaffeSpatialAveragePooling[T] = {
    ceilMode = false
    this
  }
   ...
   * @return this
   */
  def setCountIncludePad(): CaffeSpatialAveragePooling[T] = {
   ...
   * @return this
   */
  def setCountExcludePad(): CaffeSpatialAveragePooling[T] = {
  ...
  override def equals(obj: Any): Boolean = {
    ...
    if (!obj.isInstanceOf[CaffeSpatialAveragePooling[T]]) {
      return false
    }
    val other = obj.asInstanceOf[CaffeSpatialAveragePooling[T]]
    if (this.eq(other)) {
      return true
    }
...
object CaffeSpatialAveragePooling {
  def apply[T: ClassTag](
    ...
    divide: Boolean = true)(implicit ev: TensorNumeric[T]) : CaffeSpatialAveragePooling[T] = {
    new CaffeSpatialAveragePooling[T](kW, kH, dW, dH, padW, padH, globalPooling,
