 ...
 *
 * @param rate Fraction of the input units to drop. Double between 0 and 1.
...
class Dropout[T: ClassTag](
  ...
  extends klayers1.Dropout[T](p = rate, inputShape) with Net {}
