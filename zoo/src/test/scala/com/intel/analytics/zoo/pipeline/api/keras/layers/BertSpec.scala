...
class BertSpec extends ZooSpecHelper {
  ...
  "BERT" should "be able to generate correct result" in {
    ...
    expectGrad(17) = Tensor[Float](Array[Float](-1.0580f, -3.3393f, 2.1110f, 0.1864f,
    ...
    expectGrad(16) = Tensor[Float](Array[Float](-3.3787f, -2.6050f, -1.0664f, -2.2213f,
    ...
    expectGrad(15) = Tensor[Float](Array[Float]( 0.5872f, -2.5162f, -1.3089f, 2.6942f,
    ...
    expectGrad(11) = Tensor[Float](Array[Float](2.4003f, -3.1011f, 4.0827f, 0.9945f,
