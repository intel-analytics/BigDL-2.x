...
if (( $# < 4)); then
  ...
  echo "Usage example: bash release.sh linux 0.14.0.dev1 true false"
...
if [ ${upload} == true ]; then
    upload_command="twine upload python/dllib/src/dist/bigdl_dllib-${bigdl_version}-py3-none-${verbose_pname}.whl"
