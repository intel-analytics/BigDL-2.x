...
import com.intel.analytics.bigdl.common.utils.tf.Tensorflow.{booleanAttr, floatAttr, typeAttr}
import com.intel.analytics.bigdl.common.utils.tf.{TensorflowDataFormat, TensorflowSpecHelper}
