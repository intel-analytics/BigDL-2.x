...
The built-in data set has data download and preprocessing functions. Just specify the name and path, and the processed tsdata will be returned. Currently we support
