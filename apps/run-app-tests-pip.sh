...
sed "s/batch_size = 64/batch_size = 84/" ${ANALYTICS_ZOO_HOME}/apps/sentiment-analysis/sentiment.py ${ANALYTICS_ZOO_HOME}/apps/sentiment-analysis/sentiment.py >${ANALYTICS_ZOO_HOME}/apps/sentiment-analysis/tmp_test.py
