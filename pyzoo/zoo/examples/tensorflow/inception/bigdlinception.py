...
if __name__ == "__main__":
    ...
    train_data = FeatureSet.image_frame(raw_train_data).transform(train_transformer).to_dataset()
    ...
    val_data = FeatureSet.image_frame(raw_val_data).transform(val_transformer).to_dataset()
