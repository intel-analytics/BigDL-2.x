...
**In this guide we will describe how to scale out TensorFlow (v1.15) programs using Orca in 4 simple steps.** (_[Keras 2.3](./orca-keras-quickstart.md) guide is also available._)
