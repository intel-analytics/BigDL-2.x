...
echo "Downloading ambient_temperature_system_failure.csv"
wget raw.githubusercontent.com/numenta/NAB/master/data/realKnownCause/ambient_temperature_system_failure.csv
