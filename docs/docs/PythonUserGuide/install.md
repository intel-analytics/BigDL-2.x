...
2. You are recommended to download Analytics Zoo prebuilt release and nightly build package from the [Release Page](https://analytics-zoo.github.io/master/#release-download/) and uncompress it.
