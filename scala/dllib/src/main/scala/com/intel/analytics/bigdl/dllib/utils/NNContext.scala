...
import com.intel.analytics.bigdl.common.utils.{Engine, OptimizerV1, OptimizerV2, OptimizerVersion}
...
object NNContext {
  ...
  private[bigdl] def readConf: Seq[(String, String)] = {
    val stream: InputStream = getClass.getResourceAsStream("/spark-analytics-bigdl.conf")
