...
class AveragePooling2D[T: ClassTag](
  ...
  extends klayers1.AveragePooling2D[T](
    poolSize, strides, borderMode = padding, dimOrdering = dataFormat, inputShape) with Net {
}
...
object AveragePooling2D {
  def apply[@specialized(Float, Double) T: ClassTag](
    ...
    new AveragePooling2D[T](
      ...
      padding, KerasUtils.toBigDLFormat(dataFormat), inputShape)
  }
}
