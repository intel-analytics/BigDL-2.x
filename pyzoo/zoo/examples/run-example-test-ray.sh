...
echo "#6 Start tensorboard example"
start=$(date "+%s")
...
python ${ANALYTICS_ZOO_ROOT}/pyzoo/zoo/examples/orca/learn/pytorch/tensorboard/fashion-mnist_tmp.py
now=$(date "+%s")
time6=$((now-start))
...
echo "#6 tensorboard time used:$time6 seconds"
