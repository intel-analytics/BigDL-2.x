...
cp -r $BASEDIR/dllib/target/bigdl-dllib-*-SNAPSHOT-jar-with-dependencies.jar $DIST_DIR/lib
cp -r $BASEDIR/dllib/target/bigdl-dllib-*-SNAPSHOT-python-api.zip $DIST_DIR/lib
