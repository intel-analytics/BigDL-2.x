...
Download pre-trained models from [imageclassification](https://github.com/intel-analytics/analytics-zoo/master/docs/docs/ProgrammingGuide/image-classification.md)
