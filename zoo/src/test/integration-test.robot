...
Run Spark Test
   ...
   Run Shell                        ${submit} --master ${spark_master} --driver-memory 3g --executor-memory 50g  --total-executor-cores 32 --executor-cores 8 --class com.intel.analytics.zoo.examples.inception.TrainInceptionV1 ${jar_path} -f ${public_hdfs_master}:9000/imagenet-small -b 128 -i 20
   Log To Console                   begin train inceptionv1 opencv
   Run Shell                        ${submit} --master ${spark_master} --driver-memory 3g --executor-memory 50g  --total-executor-cores 32 --executor-cores 8 --class com.intel.analytics.zoo.examples.inception.TrainInceptionV1 ${jar_path} -f ${public_hdfs_master}:9000/imagenet-small -b 128 -i 20 --opencv
