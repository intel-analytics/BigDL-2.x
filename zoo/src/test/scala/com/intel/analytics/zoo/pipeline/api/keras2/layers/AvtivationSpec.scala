...
class ActivationSpec extends KerasBaseSpec {
  ...
  "tanh" should "be the same as Keras" taggedAs(Keras2Test) in {
    val kerasCode =
      """
  ...
  "relu" should "be the same as Keras" taggedAs(Keras2Test) in {
    val kerasCode =
      """
        |input_tensor = Input(shape=[4, 5])
        |input = np.random.random([2, 4, 5])
  ...
  "sigmoid" should "be the same as Keras" taggedAs(Keras2Test) in {
    val kerasCode =
      """
        |input_tensor = Input(shape=[4, 5])
        |input = np.random.random([2, 4, 5])
  ...
  "hard_sigmoid" should "be the same as Keras" taggedAs(Keras2Test) in {
    val kerasCode =
      """
        |input_tensor = Input(shape=[4, 5])
        |input = np.random.random([2, 4, 5])
  ...
  "softmax 2D input" should "be the same as Keras" taggedAs(Keras2Test) in {
    val kerasCode =
      """
  ...
  "softmax" should "be the same as Keras" taggedAs(Keras2Test) in {
    val kerasCode =
      """
        |input_tensor = Input(shape=[4, 5])
        |input = np.random.random([2, 4, 5])
  ...
  "softplus" should "be the same as Keras" taggedAs(Keras2Test) in {
    val kerasCode =
      """
        |input_tensor = Input(shape=[4, 5])
        |input = np.random.random([2, 4, 5])
  ...
  "softsign" should "be the same as Keras" taggedAs(Keras2Test) in {
    val kerasCode =
      """
        |input_tensor = Input(shape=[4, 5])
        |input = np.random.random([2, 4, 5])
  ...
  "linear" should "be the same as Keras" taggedAs(Keras2Test) in {
    val kerasCode =
      """
        |input_tensor = Input(shape=[4, 5])
        |input = np.random.random([2, 4, 5])
  ...
  "ReLU6 Zoo" should "be the same as BigDL" taggedAs(Keras2Test) in {
  ...
  "TanhShrink Zoo" should "be the same as BigDL" taggedAs(Keras2Test) in {
  ...
  "SoftMin Zoo" should "be the same as BigDL" taggedAs(Keras2Test) in {
  ...
  "LogSigmoid Zoo" should "be the same as BigDL" taggedAs(Keras2Test) in {
  ...
  "LogSoftMax Zoo" should "be the same as BigDL" taggedAs(Keras2Test) in {
  ...
  "softmax with 4d input" should "be the same as Keras" in {
    val kerasCode =
      """
  ...
  "softmax with 5d input" should "be the same as Keras" in {
    val kerasCode =
      """
        |input_tensor = Input(shape=[2, 2, 2, 2])
