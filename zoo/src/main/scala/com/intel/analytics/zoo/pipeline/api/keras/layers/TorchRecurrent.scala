...
import com.intel.analytics.bigdl.nn.{BatchNormParams, BatchNormalization, Cell, Container, Dropout, DynamicContainer, MultiRNNCell, TimeDistributed, Utils, Sequential => TSequential}
import com.intel.analytics.bigdl.serialization.Bigdl.{AttrValue, BigDLModule}
import com.intel.analytics.bigdl.tensor.Tensor
import com.intel.analytics.bigdl.tensor.TensorNumericMath.TensorNumeric
import com.intel.analytics.bigdl.utils.serializer.converters.DataConverter
import com.intel.analytics.bigdl.utils.serializer.{ContainerSerializable, ModuleSerializer, _}
 ...
 *
 */
// NB: This is a copy from BigDL. We can remove this once update to BigDL 0.7.0
...
class Recurrent[T : ClassTag](
  ...
  override def add(module: AbstractModule[_ <: Activity, _ <: Activity, T]): this.type = {
    ...
    if (batchNormParams != null) {
      ...
      preTopology = TSequential[T]().add(preTopology).add(layer)
    }
...
object Recurrent extends ContainerSerializable {
   ...
   * @param dst
   */
  private def selectCopy[T: ClassTag](
   ...
   */
  private def copyToIndex[T: ClassTag](
...
class TorchRecurrent[T : ClassTag](
    override var batchNormParams: BatchNormParams[T] = null,
    override var maskZero: Boolean = false
