...
object SSDVgg {
  ...
  def vgg16(): (ModuleNode[Float], ModuleNode[Float], ModuleNode[Float]) = {
    ...
    val relu1_2 = SSDGraph.addConvRelu(relu1_1, (64, 64, 3, 1, 1), "1_2")
    val pool1 = SpatialMaxPooling(2, 2, 2, 2).ceil().setName("pool1").inputs(relu1_2)

    val relu2_1 = SSDGraph.addConvRelu(pool1, (64, 128, 3, 1, 1), "2_1")
    val relu2_2 = SSDGraph.addConvRelu(relu2_1, (128, 128, 3, 1, 1), "2_2")
    val pool2 = SpatialMaxPooling(2, 2, 2, 2).ceil().setName("pool2").inputs(relu2_2)

    val relu3_1 = SSDGraph.addConvRelu(pool2, (128, 256, 3, 1, 1), "3_1")
    val relu3_2 = SSDGraph.addConvRelu(relu3_1, (256, 256, 3, 1, 1), "3_2")
    val relu3_3 = SSDGraph.addConvRelu(relu3_2, (256, 256, 3, 1, 1), "3_3")
    val pool3 = SpatialMaxPooling(2, 2, 2, 2).ceil().setName("pool3").inputs(relu3_3)

    val relu4_1 = SSDGraph.addConvRelu(pool3, (256, 512, 3, 1, 1), "4_1")
    val relu4_2 = SSDGraph.addConvRelu(relu4_1, (512, 512, 3, 1, 1), "4_2")
    val relu4_3 = SSDGraph.addConvRelu(relu4_2, (512, 512, 3, 1, 1), "4_3")

    val pool4 = SpatialMaxPooling(2, 2, 2, 2).ceil().setName("pool4").inputs(relu4_3)
    val relu5_1 = SSDGraph.addConvRelu(pool4, (512, 512, 3, 1, 1), "5_1")
    val relu5_2 = SSDGraph.addConvRelu(relu5_1, (512, 512, 3, 1, 1), "5_2")
    val relu5_3 = SSDGraph.addConvRelu(relu5_2, (512, 512, 3, 1, 1), "5_3")
