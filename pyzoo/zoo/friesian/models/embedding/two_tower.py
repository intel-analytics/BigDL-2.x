...
def build_model(user_col_info, item_col_info, hidden_layers=[1024, 512, 128]):
    # one tower
    ...
    user_input, user_out = build_1tower(col_info=user_col_info)
    item_input, item_out = build_1tower(col_info=item_col_info)
