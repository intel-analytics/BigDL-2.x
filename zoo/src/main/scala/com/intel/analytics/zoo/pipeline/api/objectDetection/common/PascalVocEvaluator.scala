...
package com.intel.analytics.zoo.pipeline.api.objectDetection.common

import com.intel.analytics.zoo.pipeline.api.objectDetection.common.dataset.PascalVoc._
