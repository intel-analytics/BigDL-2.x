...
class BertSpec extends ZooSpecHelper {
  ...
  "BERT" should "be able to generate correct result" in {
    ...
    val wordEmbedding = Tensor[Float](Array[Float](-0.0207f, -0.0060f, -0.0170f, 0.0058f, -0.0179f, 0.0373f, 0.0010f, 0.0004f,
      -0.0026f, 0.0072f,
      -0.0225f, 0.0093f, -0.0610f, 0.0170f, 0.0116f, 0.0049f, -0.0276f, -0.0073f,
      -0.0040f, 0.0111f,
      0.0053f, -0.0054f, 0.0242f, -0.0171f, 0.0179f, 0.0219f, 0.0001f, 0.0084f,
      0.0149f, 0.0004f,
      -0.0089f, 0.0248f, 0.0279f, -0.0002f, 0.0009f, 0.0044f, 0.0435f, 0.0439f,
      -0.0129f, 0.0336f,
      -0.0180f, -0.0170f, -0.0191f, 0.0007f, 0.0084f, 0.0393f, -0.0193f, 0.0152f,
      -0.0064f, 0.0113f,
      0.0051f, -0.0221f, 0.0165f, 0.0001f, -0.0345f, 0.0046f, 0.0078f, -0.0105f,
      -0.0024f, 0.0083f,
    ...
    val positionEmbedding = Tensor[Float](Array[Float](0.0176f, 0.0146f, 0.0055f, 0.0344f, 0.0269f, -0.0253f, 0.0090f, 0.0132f,
      -0.0130f, -0.0178f,
    ...
    val tokenTypeEmbedding = Tensor[Float](Array[Float](-0.0218f, -0.0038f, 0.0163f, -0.0165f, 0.0279f, -0.0080f, -0.0095f, 0.0120f,
      -0.0028f, -0.0104f,
      -0.0086f, -0.0187f, -0.0065f, 0.0186f, -0.0057f, 0.0169f, 0.0004f, -0.0335f,
      -0.0389f, 0.0020f), Array(2, 10))
    wb(2).set(tokenTypeEmbedding)

    val queryW = Tensor[Float](Array[Float](-0.0135f, -0.0378f, -0.0368f, 0.0026f, -0.0159f, 0.0246f, 0.0016f, 0.0361f,
      -0.0068f, -0.0093f,
      -0.0080f, -0.0262f, 0.0006f, -0.0118f, -0.0235f, 0.0348f, -0.0059f, -0.0069f,
      -0.0099f, -0.0260f,
      0.0262f, -0.0053f, 0.0039f, -0.0140f, 0.0228f, 0.0038f, -0.0002f, 0.0071f,
      -0.0085f, 0.0214f,
    ...
    val keyW = Tensor[Float](Array[Float](-0.0040f, 0.0094f, 0.0217f, -0.0098f, 0.0350f, -0.0075f, 0.0190f, 0.0261f,
      0.0226f, -0.0024f,
    ...
    val valueW = Tensor[Float](Array[Float](0.0014f, 0.0066f, 0.0252f, 0.0175f, -0.0458f, 0.0379f, -0.0464f, -0.0128f,
      -0.0171f, -0.0013f,
    ...
    val outputDenseW = Tensor[Float](Array[Float](0.0080f, 0.0329f, -0.0080f, -0.0139f, 0.0116f, -0.0004f, -0.0028f, 0.0020f,
      0.0338f, -0.0377f,
    ...
    val intermediateDenseW = Tensor[Float](Array[Float](0.0006f, 0.0003f, 0.0235f, -0.0193f, -0.0049f, -0.0136f, -0.0202f, -0.0078f,
      -0.0276f, 0.0214f,
    ...
    val denseW = Tensor[Float](Array[Float](0.0024f, 0.0089f, -0.0195f, -0.0117f, -0.0310f, 0.0060f, -0.0069f, -0.0041f,
    ...
    val gradOutput = Tensor[Float](Array[Float](21f, 52f, 1f, 87f, 29f, 37f, 1f, 63f, 59f, 20f,
    ...
    expectGrad(19) = Tensor[Float](Array[Float](-308.3242f, 73.9104f, 415.4557f,
      -667.1381f, 372.1354f, -32.4430f,
      -20.9703f, 388.4782f, -109.3576f, -259.4818f), Array(1, 10))
    expectGrad(18) = Tensor[Float](Array[Float](-102.6976f, -1.5482f, -77.3635f,
      190.8914f, 33.2574f, -53.2304f,
      -18.3125f, 52.5667f, -15.7316f, -7.8316f), Array(10))
    expectGrad(17) = Tensor[Float](Array[Float](-1.0580f, -3.3393f, 2.1110f, 0.1864f, 2.7355f, -0.9865f, -0.4861f, 0.0079f,
    ...
    expectGrad(16) = Tensor[Float](Array[Float](-3.3787f, -2.6050f, -1.0664f, -2.2213f, 1.6643f, -2.3580f, 1.3027f, 2.4582f,
    ...
    expectGrad(15) = Tensor[Float](Array[Float]( 0.5872f, -2.5162f, -1.3089f, 2.6942f, -1.8444f, 2.8932f, -0.6094f, -4.4749f,
      2.9703f, 1.6089f,
    ...
    expectGrad(14) = Tensor[Float](Array[Float](-102.0154f, -2.0866f, -78.0799f,
      190.8661f, 33.5124f, -53.4546f,
      -18.0541f, 52.2774f, -15.8880f, -7.4727f), Array(1, 10))
    expectGrad(13) = Tensor[Float](Array[Float](8.0734f, 8.6608f, -22.1519f,
      -103.3919f, -39.7637f, 128.0594f,
      -29.7084f, 55.4173f, 14.1729f, -19.3239f), Array(1, 10))
    expectGrad(12) = Tensor[Float](Array[Float](-102.0217f, -2.0389f, -78.0332f,
      190.8739f, 33.5608f, -53.3832f,
      -18.0584f, 52.2859f, -15.7794f, -7.4057f), Array(10))
    expectGrad(11) = Tensor[Float](Array[Float](2.4003f, -3.1011f, 4.0827f, 0.9945f, 1.6197f, 4.0893f, 1.0422f,
      -6.7701f, -1.8708f, -2.9517f,
    ...
    expectGrad(9) = Tensor[Float](Array[Float](-1.7866f, -3.2862f, 1.7699f, 0.2298f, 2.0777f, -1.4149f, 0.9542f, 0.0221f,
      1.8769f, -0.4430f,
    ...
    expectGrad(5) = Tensor[Float](Array[Float]( 0.0001f, 0.0019f, -0.0018f, -0.0019f, 0.0014f, -0.0010f, -0.0005f, 0.0061f,
      0.0001f, -0.0043f,
    ...
    expectGrad(1) = Tensor[Float](Array[Float](0.0000f,  0.0000f,  0.0000f,  0.0000f,  0.0000f,  0.0000f,
      0.0000f,  0.0000f,  0.0000f,  0.0000f,
      0.0000f,  0.0000f,  0.0000f,  0.0000f,  0.0000f,  0.0000f,
      0.0000f,  0.0000f,  0.0000f,  0.0000f,
