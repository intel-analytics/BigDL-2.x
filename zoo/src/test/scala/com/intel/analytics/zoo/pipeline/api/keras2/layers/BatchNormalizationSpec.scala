...
class BatchNormalizationSpec extends KerasBaseSpec  {
  ...
  "BatchNormalization" should "work properly" taggedAs(Keras2Test) in {
    val seq = Sequential[Float]()
    val layer = BatchNormalization[Float](betaInitializer = "glorot_uniform",
      gammaInitializer = "normal", inputShape = Shape(3, 12, 12))
    seq.add(layer)
